...
SSL_KEY_FILE_PATH="./secret/key.pem"
SSL_CERT_FILE_PATH="./secret/cert.pem"
MODEL_CHECKPOINT_PATH="./exp/checkpoints/epoch=2-step=42813.ckpt"
SP_MODEL_PATH="spm_unigram_1023.model"
GMVN_STATS_PATH="global_stats.json"
